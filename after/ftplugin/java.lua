...
jdtls.start({
  ...
  on_init = function(client)
    -- Must be in on_init, not on_attach: semantic token requests start before
    -- on_attach fires. Clearing here means no @lsp.type.X.java groups override treesitter.
